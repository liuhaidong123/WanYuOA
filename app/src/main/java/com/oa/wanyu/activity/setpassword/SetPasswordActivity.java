package com.oa.wanyu.activity.setpassword;
...
public class SetPasswordActivity extends AppCompatActivity {
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                ...
                Object o = gson.fromJson(s, SuccessBean.class);
                if (o != null && o instanceof SuccessBean) {

                    SuccessBean setPasswordRoot = (SuccessBean) o;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = URLTools.urlBase + URLTools.set_password;
    ...
    private boolean checkPasswordEqual() {
        //新密码是否为""
        if (!"".equals(mNewpassword.getText().toString().trim())) {
            //新密码长度是否大于6
            if (mNewpassword.getText().toString().length() == 6) {
                ...
                if (!"".equals(mSureNewPassword.getText().toString())) {
                    ...
                    if (mSureNewPassword.getText().toString().length() == 6) {
                        ...
                        Toast.makeText(this, "新密码的长度须等于6", Toast.LENGTH_SHORT).show();
                    }
