...
/**
 * Created by liuhaidong on 2019/5/10.
 */

public class FloorAddressRows {
    ...
    public int getTenantable() {
        return tenantable;
    }

    public void setTenantable(int tenantable) {
    ...
    public String getDarkingRatio() {
        return darkingRatio;
    }

    public void setDarkingRatio(String darkingRatio) {
        this.darkingRatio = darkingRatio;
    }
